...
| 02 | [Proof-Type Registry](docs/02-proof-type-registry.md) | Registry mechanics and continuity levels |
...
| 09 | [Example Schemas](docs/09-example-schemas.md) | Concrete JSON shapes |
